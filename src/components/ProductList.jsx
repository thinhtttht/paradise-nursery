...
const plantCategories = [
  {
    ...
    plants: [
      ...
      },
      {
        ...
        price: 18,
        image:
          "https://images.unsplash.com/photo-1593482892290-f54927ae2b25?auto=format&fit=crop&w=600&q=80",
      },
      {
        id: 5,
      ...
      },
      {
        ...
        price: 40,
        image:
          "https://images.unsplash.com/photo-1597055181300-e3633a917c65?auto=format&fit=crop&w=600&q=80",
      },
    ],
  },
  {
    ...
    plants: [
      {
        ...
        price: 12,
        image:
          "https://images.unsplash.com/photo-1596547609652-9cf5d8c0c9cb?auto=format&fit=crop&w=600&q=80",
      },
      {
        id: 8,
        name: "Echeveria",
      ...
      },
      {
        ...
        price: 14,
        image:
          "https://images.unsplash.com/photo-1491147334573-44cbb4602074?auto=format&fit=crop&w=600&q=80",
      },
      {
        id: 10,
  ...
  },
  {
    ...
    plants: [
      ...
      },
      {
        ...
        price: 14,
        image:
          "https://images.unsplash.com/photo-1626964644767-4f330f0a0d84?auto=format&fit=crop&w=600&q=80",
      },
      {
        id: 17,
        name: "Rubber Plant",
        price: 28,
        image:
          "https://images.unsplash.com/photo-1616500166943-0f91959c3e91?auto=format&fit=crop&w=600&q=80",
      },
      {
        id: 18,
        name: "ZZ Plant",
        price: 24,
        image:
          "https://images.unsplash.com/photo-1586093248292-4e0dfc7b0082?auto=format&fit=crop&w=600&q=80",
      },
    ],
  },
];
...
function ProductList({ onViewCart }) {
  ...
  return (
    <main className="product-page">
      ...
      <p>
        Browse our plant collection and add your favorites to the shopping cart.
      </p>

      <button onClick={onViewCart}>Go to Cart</button>
